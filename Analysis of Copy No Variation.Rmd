...
#1.	a) Altered in this sample? (1 point)
31 then 28
#b) Gained or amplified (>LOG2RATIO >=0.585)? (1 point) 
```{r}
...
#c) Lost or deleted(>LOG2RATIO <=-0.585)? (1 point)
...
#2.	What region is most amplified? (2 points)
...
#3.	What region is most deleted? (2 points)
...
#4.	Plot the resulting copy number profile (2 points)
...
#5.	What cytoband is altered in the most samples? (1 point)
```{r}
...
#6.	Is it an Amplification or a deletion? (1 point)
amplificaion

#7.	How many samples is it altered in? (1 point)
...
#8.	How many significant amplification and deletions are there (q <0.05)? (1 point)
...
#9.	Which sample has the most alterations? And the least? (2 points)
```{r}
...
#10.	Which altered cytoband contains the most genes? (1 point)
```{r}
# most altered
